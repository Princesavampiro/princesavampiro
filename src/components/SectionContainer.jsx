...
export default function SectionContainer() {
  ...
  return (
    <div
      className={`h-full overflow-hidden bg-[#000000aa] backdrop-blur-xl sm:bg-transparent sm:backdrop-blur-none ${location.pathname.split("/").length > 2 ? "max-h-screen" : "min-h-screen"}`}
    >
