...
export default function DraggableWindow({ title, children, className }) {
  ...
  return (
    <motion.div
      ...
      dragMomentum={false}
      className={`flex h-full flex-col rounded-lg border-white/30 select-none sm:overflow-hidden sm:border sm:bg-[#00000022] sm:drop-shadow-[0_0_12px_#000] sm:backdrop-blur-sm ${className} hover:z-30 active:z-30`}
    >
      {!isMobile && (
        <div
